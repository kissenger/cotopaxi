...
//     public isLong() {
//         return this.coordinates.length > globals.LONG_PATH_THRESHOLD ? true : false;
//     }
...
//     private elevs: Array<number> = []; //flattened
//     private cumDistance: Array<number>;  //flattened
...
//     public isLong() {
//         return this.coords.length > globals.LONG_PATH_THRESHOLD ? true : false;
//     }
...
//         this.cumDistance = this.geoService.getCumDistance(this.coords);
//         this.elevs = this.elevs.concat(path.getElevs());
//         this.addStats(path.getPathStats());
//         this.geoJSON.remLineString();
//         this.geoJSON.addLineString( this.coords, this.geoService.smoothElevations(this.elevs), this.getStats(), this.isLong(), this.cumDistance );
//     }
